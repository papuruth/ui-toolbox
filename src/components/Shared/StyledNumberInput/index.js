...
export default function StyledNumberInput({ placeholder, value, onChange, ...restProps }) {
    return <NumberInput placeholder={placeholder} value={value} onChange={onChange} {...(restProps || {})} />;
}
